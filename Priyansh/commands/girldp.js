module.exports.config = {
  ...
  version: "1.0.0",
  hasPermssion: 0,
  credits: "Aaryan Babu", // Maine credits badal diye hain kyunki code puri tarah se badal gaya hai
...
module.exports.run = async ({ api, event, args }) => {
  ...
  // Naye aur sahi links daale gaye hain
  const links = [
  ...
  try {
    ...
    api.sendMessage(`Maaf, photo download nahi ho saki. Kripya thodi der baad dobara koshish karein.`, event.threadID);
    fs.unlink(filePath, () => {});
  }
};
